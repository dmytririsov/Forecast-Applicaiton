...
public class EventDetails extends AppCompatActivity {
    ...
    private final static String TAG = EventDetails.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.support_simple_spinner_dropdown_item, mEventType);
